...
-- Metabase variables: date_from, date_to (Date), page, source, device_type,
-- country, plan_filter, payment_method (Text - optional). page = page viewed (same as page_name).
-- =============================================================================
